...
namespace OMS.Ice.T4Generator.UnitTest.Settings
{
    public class LineEndingsTest : TestCase
    {
        ...
        public void TestCSLineEndingsCR()
        {
            ...
            Run( @"Settings\LineEndingsTest.t4", "a\rb\rc\r", new object[0] );
        }
        ...
        public void TestCSLineEndingsLS()
        {
            ...
            Run( @"Settings\LineEndingsTest.t4", "a\u2028b\u2028c\u2028", new object[0] );
        }
